<template>
    <div class="reservation-details flex reservation-layout">
        ...
        <div class="reservation-total-price" v-if="nights">
            ...
            <div class="total-last"><span>service fee</span><span>$300</span></div>
            <p>
                <span>Total:</span><span>${{ totalPrice + 300 }}</span>
            </p>
        </div>
    </div>
    <div v-if="this.openReservModal" class="modal-reserv-overlay"></div>
        ...
        <div class="modal-main flex column">
          ...
          ">
            ...
            <div class="trip-det flex column">
                ...
                <div class="flex justify-between">
                    <span class="bold checkin">Check-In</span>
                </div>
                <div class="flex justify-between">
                    <span class="bold checkout">Check-Out</span>
                </div>
                <div class="flex justify-between">
                    <span class="bold night">Host name:</span>{{ this.stay.host.fullname }}
                </div>
            </div>
            <div class="flex column">
                ...
                <div class="price-det">
                    ...
                    <div class="flex justify-between">
                        <span class="bold adult">Adults:</span>{{ this.adultAmount }}
                    </div>
                    <div class="flex justify-between">
                        <span class="bold price">Total price:</span>${{ this.totalPrice }}
                    </div>
                    <div class="flex justify-between">
                        <span class="bold night">Total nights:</span>{{ this.nights }}
                    </div>
                </div>
            </div>
            <button class="reserve-btn" @click="goToStays">
