    ...
    <div class="main-mob-details" v-if="!isReservationOpen">
      <div class="images-mob">
        <carousel :autoplay="5000" :items-to-show="1">
          <slide v-for="slide in stay.imgUrls.length" :key="slide">
            <img
              v-bind:src="'/img/Images/' + stay.imgUrls[slide - 1]"
              alt=""
              class="ratio-card"
            />
          </slide>
      ...
      <div class="host-sec">
        <div class="txt-container">
          ...
          <p>
            {{ stay.capacity.guests }} guests <span class="dot"></span>
            {{ stay.capacity.bedrooms }} bedrooms
            <span class="dot"></span>
            {{ stay.capacity.beds }} beds <span class="dot"></span>
            {{ stay.capacity.bathrooms }} bathrooms
          </p>
        </div>
        <div>
          <img :src="'/img/peopleImages/' + avatarImg" class="avatar" alt="" />
        </div>
      </div>
      <hr />
      <extras-details />
